          ...
          <div className="my-5 container ">
            <div className="row my-lg-4 programs">
              <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                <div
                  className="card programs   shadow rounded"
                  style={{
            ...
            <div className="row my-lg-4">
              <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                ...
                >
                  <div className="card-body text-center">
                    <QuestionAnswerIcon />
                    <h4>FINANCE MANAGEMENT SERVICES</h4>
                  </div>
                </div>
              </div>
              <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                ...
                >
                  <div className="card-body text-center">
                    <HandshakeIcon />
                    <h4>PRE DEPARTURE PREPARATIONS</h4>
                    <br />
                  </div>
                </div>
              </div>
              <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                ...
                >
                  <div className="card-body text-center">
                    ...
                    <h4>ON-CAMPUS LIVING SUPPORT</h4>
                    <br />
                  </div>
                </div>
              </div>
              <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                <div
                  className="card  shadow rounded programs"
                  style={{
                    background: "rgba(255, 255, 255, 0.7)",
                    color: "white",
                  }}
